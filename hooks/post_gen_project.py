"""## Genera una ambiente virtual, instala los paquetes de requierements.txt
import os
import subprocess
...
if "{{ cookiecutter.project_packages }}" == "Notebook":
    subprocess.call(
        [python_venv, "-m", "ipykernel", "install", "--user", "--name", "venv"]
    )
...
"""
## Para inicializar git y hacer el primer commit
import subprocess
